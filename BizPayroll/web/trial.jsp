<%-- 
    Document   : trial
    Created on : 31 May, 2008, 3:55:38 PM
    Author     : imran
--%>
                                        ...
                                        <form action="j_acegi_security_check" method="POST">
                                            <center>
                                                <table>
                                                    ...
                                                    <tr><td><img src="images/users.gif" width="20" height="20" alt="icon2-normal"/>
                                                    ...
                                                    <tr><td><img src="images/pwd.gif" width="20" height="20" alt="icon4-normal"/>
